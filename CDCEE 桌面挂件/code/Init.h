...
__declspec(selectany) SDL_Color colorBG_main = { 0, 0, 0, 0xAA };
...
__declspec(selectany) SDL_Color colorBG_title = { 0, 0, 0, 0 };
...
__declspec(selectany) SDL_Color colorBG_CD = { 0, 0, 0, 0 };
